...
# 
# df_filtered$partner_same_sex_2 <- ifelse(is.na(df_filtered$partner_same_sex_2) | df_filtered$partner_same_sex_2 == "Refused",
#                                              NA,
#                                              as.logical(!is.na(str_extract(df_filtered$partner_same_sex_2, "^Yes"))))
...
```{r}
tbl_vars(df_filtered)
```
```{r}
df_filtered %>%
  mutate(column = coalesce(ever_lived_together_w_partner, ever_lived_together_w_partner_2, currently_living_with_partner)) %>%
  select(column, ever_lived_together_w_partner, ever_lived_together_w_partner_2, currently_living_with_partner)
```
...
df_of_interest <- df_filtered %>% 
  filter(married | ever_had_partner) %>% 
...
#  [71] "who_wanted_breakup_more_nonmar"       "marriage_end_mar"                    
#  [73] "who_broke_up"                         "partner_same_sex_2"                  
#  [75] "partner_hispanic_latino_2"            "year_partner_born_2"                 
#  [77] "partner_education_level_2"            "partner_mother_education_level_2"    
#  [79] "partner_polictial_belief_2"           "your_mother_education_level_2"       
#  [81] "met_partner_location_2"               "number_relatives_you_visit_2"        
#  [83] "Q16_2_Codes"                          "times_married_2"                     
#  [85] "gender_sexually_attracted_to_1_2"     "gender_sexually_attracted_to_2_2"    
#  [87] "ever_lived_together_w_partner_2"      "date_met_year_2"                     
#  [89] "date_met_month_2"                     "date_relationship_began_year_2"      
#  [91] "date_relationship_began_month_2"      "date_first_lived_together_year_2"    
#  [93] "date_first_lived_together_month_2"    "date_married_year_2"                 
#  [95] "date_married_month_2"                 "date_broken_up_year_2"               
#  [97] "date_broken_up_month_2"               "Q21F_2_start_range"                  
#  [99] "date_partner_pass_year"               "date_partner_pass_month"             
# [101] "sexual_orientation_2"                 "outness_2"                           
# [103] "age_came_out_2"                       "income_disparity_2"                  
# [105] "same_high_school_2"                   "same_university_2"                   
# [107] "grow_up_same_town_2"                  "parents_knew_each_other_before_met_2"
# [109] "mutual_friends_prior_1_2"             "mutual_friends_prior_2_2"            
# [111] "mutual_friends_prior_3_2"             "mutual_friends_prior_4_2"            
# [113] "w6_friend_connect_2_Refused"          "met_online_2"                        
# [115] "other_date_2"                         "number_others_dated_2"               
# [117] "dating_app_met_other_2"               "how_many_met_dating_app_2"  
select(married,
       ever_had_partner,
       age_when_met,
       partnership_status,
...
convert_met_online <- function(x) {
  case_when(
    x == 0 ~ "No, I did NOT meet [Partner Name] through the Internet",
    x == 1 ~ "Yes, an Internet dating or matchmaking site (like eHarmony or match.com)",
  )
}

convert_met_online(df_of_interest$met_online)
